...
public class PbChAdapter extends BaseAdapter {

	private Context context;

	private List<ChannelPublic> list;

	private GridView gridView;

	public PbChAdapter(Context context, List<ChannelPublic> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ChannelPublic chp = list.get(position);
